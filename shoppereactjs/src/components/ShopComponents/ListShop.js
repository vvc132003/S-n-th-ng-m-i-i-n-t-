                ...
                <Layout>
                    ...
                    <main className="main-content container mt-4">
                        <div className="d-flex justify-content-end mb-3">
                            ...
                            <Link to="/admin/addshop" className="btn btn-primary d-flex align-items-center">
                                        ...
                                        (() => {
                                            ...
                                            return currentUsers.map(shop => (
                                                <tr key={shop.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/admin/editshop?idshop=${shop.id}`} className="icon-link mr-3" style={{ color: 'yellowgreen' }}>
