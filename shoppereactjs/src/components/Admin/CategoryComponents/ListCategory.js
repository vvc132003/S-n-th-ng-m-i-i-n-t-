            ...
            <Layout>
                ...
                <main className="main-content container mt-4">
                    <div className="d-flex justify-content-end mb-3">
                        ...
                        <Link to="/admin/category/addcategory" className="btn btn-primary d-flex align-items-center">
                                        ...
                                        (() => {
                                            ...
                                            return currentUsers.map(category => (
                                                <tr key={category.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/admin/category/editcategory?idcategory=${category.id}`} className="icon-link mr-3" style={{ color: 'yellowgreen' }}>
