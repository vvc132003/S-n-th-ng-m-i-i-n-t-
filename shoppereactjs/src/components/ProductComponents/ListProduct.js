                ...
                <Layout>
                    ...
                    <main className="main-content container mt-4">
                        <div className="d-flex justify-content-end mb-3">
                            ...
                            <Link to="/admin/addProduct" className="btn btn-primary d-flex align-items-center">
                                        ...
                                        (() => {
                                            ...
                                            return currentUsers.map(product => (
                                                <tr key={product.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/admin/editcategory?idcategory=${product.id}`} className="icon-link mr-3" style={{ color: 'yellowgreen' }}>
